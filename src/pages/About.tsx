      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start">
        <div className="lg:w-2/3">
          ...
          <p className="text-lg mb-4">
            Hi! I'm Ethan. My experience includes a business intelligence engineer internship at <a href="https://www.linkedin.com/in/ethanwongca/" className="text-pink-500"> <b>Amazon's Supply Chain Optimization Technology Forecasting Team</b></a> and serving as an AI Fellow at the <a href="https://www.linkedin.com/in/ethanwongca/" className="text-pink-500"> <b>United Nation's OICT Innovation Unit</b></a>. I currently do LLM interpretability and computational social science research at UBC and have previous experience in NLP and multimodal LLM research at UBC and McGill. On this portfolio, you can find my resume, projects, and publications.
          </p>
          <p className="text-lg mb-4">
