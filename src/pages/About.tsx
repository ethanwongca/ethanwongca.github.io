      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start">
        <div className="lg:w-2/3">
          ...
          <p className="text-xl mb-2">
            <a href="ethanwongca.github.io" className="text-pink-600">Computer Science at UBC. </a> Vancouver, BC. <a href="https://www.linkedin.com/in/ethanwongca/" className="text-pink-600 hover:underline">Linkedin</a>.
          </p>
          <p className="text-lg mb-4">
            Hello, my name is Ethan and I am Computer Science Student at UBC. I am currently developing artificial intelligence tools for the <a href="https://www.linkedin.com/in/ethanwongca/" className="text-pink-500"> United Nations </a> and UBC. I am interested in software development, human computer interaction, and machine learning. On this portfolio you can find my resume, projects, and publications.
          </p>
          <p className="text-lg mb-4">
